...
{
    public class PayTypeController : AdminBaseController
    {
        // GET: PayType
        ...
        [OprtLogFilter(IsRecordLog = true, Method = "", IsFormPost = true, Entitys = new Type[] { typeof(PayType) }, LogWay = OprtLogType.新增和修改)]
