...
{
    public class PosDefineController : AdminBaseController
    {
        ...
        {
            if (id == 0)
                return View(new PosDefine() { HotelId = UserContext.CurrentUser.HotelId });
        ...
        [OprtLogFilter(IsRecordLog = true, Method = "", IsFormPost = true, Entitys = new Type[] { typeof(PosDefine) }, LogWay = OprtLogType.新增和修改)]
