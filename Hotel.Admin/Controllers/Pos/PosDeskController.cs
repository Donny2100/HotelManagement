...
{
    public class PosDeskController : AdminBaseController
    {
        ...
        public ActionResult Edit(long posId, long id = 0)
        {
            ViewBag.PosId = posId;
            if (id == 0)
                return View(new PosDesk() { PosId = posId });
        ...
        [OprtLogFilter(IsRecordLog = true, Method = "", IsFormPost = true, Entitys = new Type[] { typeof(PosDesk) }, LogWay = OprtLogType.新增和修改)]
